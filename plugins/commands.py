...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('', url=''),
            InlineKeyboardButton('🥀 ʙᴏᴛ ᴄʜᴀɴɴᴇʟ ', url='https://t.me/ks_bots')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        if AUTO_DELETE_MODE == True:
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>Your 📁 File Will Auto Delete In ⏰ 30 Minutes.↗️ Forward It Anywhere Or Save It Privately Before Downloading</b>")
            ...
            for x in filesarr:
                try:
                    ...
                    pass
            await k.edit_text("<b>File Removed Due to Copyright Issue</b>")
        return
